...
import com.Ankit.CarbonCellBackendDevAssessment.Exceptionhandling.Exceptions.UserNotFoundException;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(user==null){
            throw new UserNotFoundException("User not found for user Name : "+username);
        }
